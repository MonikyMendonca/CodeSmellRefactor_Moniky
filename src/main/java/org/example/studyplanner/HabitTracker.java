...
public class HabitTracker {
    ...
    public int handleAddHabitAdapter(List<String> stringProperties, List<Integer> intProperties, boolean isConcluded) {
        HabitCreationData data = buildHabitDataFromLists(stringProperties, intProperties, isConcluded);
        return addHabit(data);
    }

    private HabitCreationData buildHabitDataFromLists(List<String> stringProperties, List<Integer> intProperties, boolean isConcluded) {
